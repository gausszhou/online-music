...
const http = {
  ...
  getSongDetail: (params) =>
    get(baseUrl + "/song/detail" + serialize(params)),
  // 获取MV视频地址 /mv/url id
  getMVUrl: (params) => get(baseUrl + "/mv/url" + serialize(params)),
  // 获取MV详情 /mv/detail mvid
  getMVDetail: (params) =>
    get(baseUrl + "/mv/detail" + serialize(params)),
  // 获取歌词 /lyric id
  ...
  getNewMV: (params) =>
    get(baseUrl + "/personalized/mv" + serialize(params)),
  ...
  // 获取轮播图 /dj/banner
  getDJBanner: (params) =>
    get(baseUrl + "/dj/banner" + serialize(params)),
  ...
  getArtistList: (params) =>
    get(baseUrl + "/artist/list" + serialize(params)),
  ...
  // 获取MV评论  /comment/mv
  getCommentMV: (params) =>
    get(baseUrl + "/comment/mv" + serialize(params)),
  ...
  getCommentHot: (params) =>
    get(baseUrl + "/comment/hot" + serialize(params)),
  ...
  getArtistDesc: (params) =>
    get(baseUrl + "/artist/desc" + serialize(params)),
  getArtistTopSong: (params) =>
    get(baseUrl + "/artist/top/song" + serialize(params)),
  // /artist/mv?id=6452
  getArtistMV: (params) =>
    get(baseUrl + "/artist/mv" + serialize(params)),
