...
const http = {
  ...
  getSongDetail: (params) =>
    axios.get(baseUrl + "/song/detail" + serialize(params)),
  // 获取MV视频地址 /mv/url id
  getMVUrl: (params) => axios.get(baseUrl + "/mv/url" + serialize(params)),
  // 获取MV详情 /mv/detail mvid
  getMVDetail: (params) =>
    axios.get(baseUrl + "/mv/detail" + serialize(params)),
  // 获取歌词 /lyric id
  ...
  getPersonalized: (params) =>
    axios.get(baseUrl + "/personalized" + serialize(params)),
  // 获取独家放送 /personalized/privatecontent
  getPrivatecontent: (params) =>
    axios.get(baseUrl + "/personalized/privatecontent" + serialize(params)),
  // 获取最新音乐 /personalized/newsong
  getNewSong: (params) =>
    axios.get(baseUrl + "/personalized/newsong" + serialize(params)),
  // 获取最新MV /personalized/mv
  getNewMV: (params) =>
    axios.get(baseUrl + "/personalized/mv" + serialize(params)),

  // 发现音乐-歌单
  // 获取精品歌单 /top/playlist/highquality
  getTopPlayListDetail: (params) =>
    axios.get(baseUrl + "/top/playlist/highquality" + serialize(params)),
  // 获取歌单列表 /top/playlist
  getTopPlayList: (params) =>
    axios.get(baseUrl + "/top/playlist" + serialize(params)),

  // 发现音乐-主播电台
  // 获取轮播图 /dj/banner
  getDJBanner: (params) =>
    axios.get(baseUrl + "/dj/banner" + serialize(params)),
  // 电台个性推荐 /dj/personalize/recommend
  getDJRecommend: (params) =>
    axios.get(baseUrl + "/dj/personalize/recommend" + serialize(params)),
  ...
  getArtistList: (params) =>
    axios.get(baseUrl + "/artist/list" + serialize(params)),
  ...
  getPlayListDetail: (params) =>
    axios.get(baseUrl + "/playlist/detail" + serialize(params)),

  // 获取歌单评论 /comment/playlist
  getCommentPlayList: (params) =>
    axios.get(baseUrl + "/comment/playlist" + serialize(params)),
  // 获取热门评论  /comment/hot
  getCommentHot: (params) =>
    axios.get(baseUrl + "/comment/hot" + serialize(params))
};
